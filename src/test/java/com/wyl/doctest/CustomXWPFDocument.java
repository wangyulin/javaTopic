...
public class CustomXWPFDocument extends XWPFDocument {
	...
	public static void main(String[] args) {
		//OPCPackage pack = POIXMLDocument.openPackage("newTest.docx");
		//CustomXWPFDocument doc = new CustomXWPFDocument(pack);
		//int ind = doc.addPicture(new FileInputStream("/Users/wangyulin/Desktop/1.jpeg"), XWPFDocument.PICTURE_TYPE_JPEG);
